...
integrator.register_hook(NeighborListHook(model.model_config.neighbor_config))
...
langevin.register_hook(NeighborListHook(model.model_config.neighbor_config))
