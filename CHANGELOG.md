...
- **Extensible batch levels** - `LevelSchema` and `Batch` now support custom
  ...
  fields, and cardinalities are preserved through construction, reconstruction,
  selection, append, reusable buffers, point-to-point transport, and Zarr
  persistence. Existing atom, edge, and system APIs remain compatible,
